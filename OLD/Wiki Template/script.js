(function(){
  ...
  (function fetchCeeVersion(){
    ...
    if(!el) return;
    const url = 'https://raw.githubusercontent.com/K2568/K2568.github.io/main/wikilink/version.txt';
    fetch(url, {cache: 'no-cache'})
      ...
      .then(txt=>{
        ...
        else el.textContent = 'Up to date for _ version: error';
      })
      .catch(err=>{
        el.textContent = 'Up to date for _ version: error';
      })
  })();
})();
